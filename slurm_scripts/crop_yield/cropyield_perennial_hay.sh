...
python ../compute_mean_crop_yields.py --runId ${SLURM_ARRAY_TASK_ID} --watershedDataFile '../data/VIC_gridcode_latlong_area_watershed.csv' --targetCropType 'perennial_hay' --cropCodeFile '../data/crop_types.json' --resultDirPrefix '/scratch/jcr5wj/agaid/test_results/w2_apr_23/' --outDir '/scratch/jcr5wj/agaid/agg_results/w5_oct_23/mean_cropyield/'
